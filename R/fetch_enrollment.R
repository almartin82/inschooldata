...
#' Fetch Indiana enrollment data
#'
#' Downloads and processes enrollment data from the Indiana Department of
...
#'   corporation_id, school_id, names, and enrollment counts by demographic/grade.
